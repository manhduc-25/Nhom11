...
<div class="footer">
    ...
    <div class="pay-method">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 256 199">
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 48 48">
            <circle cx="34.571" cy="13.429" r="7" fill="none" stroke="currentColor" stroke-linecap="round"
            ...
            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                ...
                stroke-width="5" />
            <circle cx="34.571" cy="34.571" r="7" fill="none" stroke="currentColor" stroke-linecap="round"
                stroke-linejoin="round" stroke-width="5" />
        </svg>
    </div>
    <!-- contact -->
